	...
	<div class="cart bundle_data bundle_data_<?php echo $product_id; ?>" data-bundle_price_data="<?php echo esc_attr( json_encode( $bundle_price_data ) ); ?>" data-bundle_id="<?php echo $product_id; ?>"><?php
		...
		if ( $product->is_purchasable() ) {
			...
			?><div class="bundle_wrap">
				<div class="sticky-pricebar bundle_price">
					<p class="price zero"><span class="total">Total: £0.00</span></p>
				</div>
				...
				<p class="bundle_info_sub"><i>Subsidies and discounts will be calculated at checkout</i></p>
