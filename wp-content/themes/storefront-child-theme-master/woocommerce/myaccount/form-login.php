...
<div class="u-columns col2-set" id="customer_login">
	...
	<div class="u-column1 col-1" id="myacc-login">

<?php endif; ?>

		<h2 class="myacc-title"><?php _e( 'Sign in', 'woocommerce' ); ?></h2>
...
<?php if ( get_option( 'woocommerce_enable_myaccount_registration' ) === 'yes' ) : ?>
	...
	<div class="u-column2 col-2" id="myacc-register">

		<h2 class="myacc-title"><?php _e( 'Sign up', 'woocommerce' ); ?></h2>
