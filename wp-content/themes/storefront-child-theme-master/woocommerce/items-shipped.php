...
<p><?php print( __( "Part of your order has been dispatched.", 'woocommerce' ) ); ?></p>

<p><?php print( __( "Please <a href="">login</a> to your <a href="">Lean Lunch account</a> to view full details.", 'woocommerce' ) ); ?></p>
