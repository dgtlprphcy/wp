...
class WooCommerce_Groupons_Coupons_Admin {
	...
	public static function shop_coupon_columns( $posts_columns ) {
		$posts_columns['groups'] = sprintf(
			__( '<span title="%s">Groups</span>', WOO_GROUPONS_PLUGIN_DOMAIN ),
			__( 'Coupons are limited to members of the groups shown.', WOO_GROUPONS_PLUGIN_DOMAIN ) . ' ' .
			__( 'Coupons cannot be used by members of groups shown within parenthesis.', WOO_GROUPONS_PLUGIN_DOMAIN )
		);
