...
class Variable_Customer_Referral_Coupon extends AutomateWoo\Variable {
	...
	function load_admin_details() {
		$this->description = __( "Displays a coupon that the customer can use to refer their friends. If you are using this with an order trigger it is recommended to set a fallback because if the order is placed by a guest user no coupon will be displayed.", 'automatewoo');
	}
