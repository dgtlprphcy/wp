		...
		<div class="automatewoo-dashboard-chart">
			...
			<div class="automatewoo-dashboard-chart__header">
				...
				<div class="automatewoo-dashboard-chart__header-group">
					<div class="automatewoo-dashboard-chart__header-figure"><?php echo $this->_count ?></div>
					<div class="automatewoo-dashboard-chart__header-text">
						...
						<?php _e( 'referral invites sent', 'automatewoo' ) ?>
					</div>
				</div>

				<a href="<?php echo AW_Referrals()->admin->page_url( 'invites' ) ?>" class="automatewoo-arrow-link"></a>
			</div>
