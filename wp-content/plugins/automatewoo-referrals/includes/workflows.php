...
class Workflows {
	...
	static function triggers( $triggers ) {
		...
		$triggers['new_referral'] = 'AutomateWoo\Referrals\Trigger_Referral_Status_Changed';
		$triggers['referral_status_changed'] = 'AutomateWoo\Referrals\Trigger_New_Referral';
	 ...
	 * @return array
	 */
	static function inject_preview_data( $data_layer ) {
