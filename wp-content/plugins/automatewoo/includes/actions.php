...
class Actions extends Registry {
	...
	static function load_includes() {
		...
		$includes = [
			...
			'custom_function' => 'AutomateWoo\Action_Custom_Function',
			'update_product_meta' => 'AutomateWoo\Action_Update_Product_Meta',
			'clear_queued_events' => 'AutomateWoo\Action_Clear_Queued_Events',
			'change_post_status' => 'AutomateWoo\Action_Change_Post_Status',
