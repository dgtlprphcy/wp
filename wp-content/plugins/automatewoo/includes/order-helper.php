...
class Order_Helper {
	...
	function __construct() {
		...
		add_action( 'woocommerce_order_status_changed', [ $this, 'update_customer_last_order_date' ], 100, 3 );
	...
	function update_customer_last_order_date( $order_id, $old_status, $new_status ) {
		...
		if ( ! in_array( $new_status, apply_filters( 'automatewoo/customer/last_order_date_statuses', [ 'completed', 'processing' ] ) ) ) {
			return;
		}
