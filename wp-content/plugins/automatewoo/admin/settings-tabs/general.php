...
class Settings_Tab_General extends Admin_Settings_Tab_Abstract {
	...
	function load_settings() {
		...
		$this->add_setting( 'abandoned_cart_timeout', [
			...
			'desc' => __( 'Set the number of minutes from when a cart is last active to when it is considered abandoned. Default value is 15.', 'automatewoo' ),
		]);
		...
		$this->add_setting( 'queue_batch_size', [
			...
			'desc' => __( 'Sets the maximum number of queued events to process at once. The queue runs every 5 minutes. Default value is 50.', 'automatewoo' ),
		]);
		...
		$this->add_setting( 'clean_expired_coupons', [
			...
			'desc' => __( 'Coupons will be deleted 14 days after they expire. Only coupons generated by AutomateWoo will be deleted.', 'automatewoo' ),
			'type' => 'checkbox'
		]);
