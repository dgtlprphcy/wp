...
class Carts extends Base {
	...
	private function output_list_table() {
		...
		$sidebar_content = '<p>' .
			__( 'Currently active carts are shown here which includes any cart that has not been cleared at purchase or emptied by its owner. Carts are automatically deleted 60 days after their last update.', 'automatewoo' )
			. '</p>';
