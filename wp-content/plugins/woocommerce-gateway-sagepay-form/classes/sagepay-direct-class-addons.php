        ...
        function woocommerce_process_scheduled_subscription_payment( $amount_to_charge, $order ) {
            ...
            if( $sagepaytoken && $sagepaytoken != '' ) {
                ...
                $data = array(
                    ...
                    "Description"       =>   __( 'Order', 'woocommerce_sagepayform' ) . ' ' . str_replace( '#' , '' , $order->get_order_number() ),                        "BillingSurname"    =>  $pre_wc_30 ? $order->billing_last_name : $order->get_billing_last_name(),
