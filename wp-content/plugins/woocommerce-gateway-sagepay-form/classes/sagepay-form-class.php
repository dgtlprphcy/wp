    ...
    class WC_Gateway_Sagepay_Form extends WC_Payment_Gateway {
        ...
        public function generate_sagepay_form( $order_id ) {
            ...
            $sage_pay_args_array = array(
                ...
                'DeliveryState'     => apply_filters( 'woocommerce_sagepay_form_deliverystate', WC_Sagepay_Common_Functions::sagepay_state( $pre_wc_30 ? $order->shipping_country : $order->get_shipping_country(), $this->check_shipping_address( $order, 'shipping_state' ) ), $order ),
                ...
                'DeliveryCountry'   => apply_filters( 'woocommerce_sagepay_form_deliverycountry', $this->check_shipping_address( $order, 'shipping_country' ), $order ),
